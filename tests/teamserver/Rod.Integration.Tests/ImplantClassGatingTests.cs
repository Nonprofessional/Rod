...
public class ImplantClassGatingTests
{
    ...
    [InlineData(ImplantClass.Stage2, "fs.list", HttpStatusCode.Created)]
    [InlineData(ImplantClass.Stager, "fs.list", HttpStatusCode.UnprocessableEntity)]
    ...
    [InlineData(ImplantClass.Stager, "collect.cred", HttpStatusCode.UnprocessableEntity)]
