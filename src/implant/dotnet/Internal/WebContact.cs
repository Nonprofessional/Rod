...
// build, so the artifact ships no web contact code it can never run.
...
/// that asks for it.
/// </summary>
internal static class WebContact
{
    public static IContactClient Create(ContactSetup setup) => new EnvelopeBeacon(
        setup.Egress,
