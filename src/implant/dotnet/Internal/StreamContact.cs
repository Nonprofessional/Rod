...
// gRPC Beacon.Contact client and its factory. A whole source-file module --
...
/// consumes the contact mode (stream vs poll) and the private key half of
...
/// same run.
/// </summary>
internal static class StreamContact
{
    public static IContactClient Create(ContactSetup setup) => new Beacon(
        setup.Config.Mode,
        setup.Egress,
