...
/// core set. These sets are the server's authority for what a class is allowed
...
public static class ImplantClassCapabilities
{
    ...
    /// full core set; every other class carries the subset its operational
    /// purpose justifies (architecture.md Sec 5.2). Stored read-only and
    ...
    private static readonly IReadOnlyDictionary<ImplantClass, IReadOnlyList<string>> ByClass =
        ...
        {
            // The primary long-haul implant: the whole core baseline
